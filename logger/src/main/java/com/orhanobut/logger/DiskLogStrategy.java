...
public class DiskLogStrategy implements LogStrategy {
  ...
  public DiskLogStrategy(@NonNull EventHandler handler) {
  ...
  static class WriteHandler extends EventHandler {
    ...
    WriteHandler(@NonNull EventRunner looper, @NonNull String folder, int maxFileSize) {
      super(checkNotNull(looper));
      this.folder = checkNotNull(folder);
      this.maxFileSize = maxFileSize;
    }

    public void handleMessage(@NonNull InnerEvent msg) {
